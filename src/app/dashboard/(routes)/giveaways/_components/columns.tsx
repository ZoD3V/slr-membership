...
export const giveawaysColumns: Column[] = [
    ...
    { key: 'entries', label: 'Entries', render: (row) => <span className='tabular-nums'>{row.entries}</span> },
    { key: 'winners', label: 'Winners', render: (row) => <span className='tabular-nums'>{row.winners}</span> },
